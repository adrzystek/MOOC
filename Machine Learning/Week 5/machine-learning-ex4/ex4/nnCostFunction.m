...
%J = (sum(sum((-first_part - second_part)))) / m;  % Part 3
...
%
%J = (sum(sum((-first_part - second_part))) + lambda / 2 * (reg1 + reg2)) / m;  % Part 4
...
%	h = a3;
%	
%	_y = Y(i, :)'; %(1:num_labels)' == y(i);
%	J += sum(-_y .* log(h) - (1 - _y) .* log(1 - h));
%	
%	delta3 = a3 - _y;
%	
